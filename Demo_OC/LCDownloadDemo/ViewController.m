...
- (void)viewDidLoad {
    ...
    label1.text = [NSString stringWithFormat:@"%.2f",[lc_D progressWithURL:URL]];
    ...
    pv1.progress = [lc_D progressWithURL:URL];
    ...
    label2.text = [NSString stringWithFormat:@"%.2f",[lc_D progressWithURL:URL]];
    ...
    pv2.progress = [lc_D progressWithURL:URL];
...
- (void)click1:(UIButton *)button {
    ...
    [[LCDownloadManager sharedInstance] downloadDataWithURL:URL resume:button.selected progress:^(CGFloat progress) {
...
- (void)remove1:(UIButton *)button {
    ...
    _pv1.progress = 0;
    _button1.selected = NO;
    [[LCDownloadManager sharedInstance] removeFileDataWithURL:URL];
}
